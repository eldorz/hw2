...
# Make all words lower case. Remove stopwords. Stem words. <br> is not a word.
...
def get_dataset(vocabulary_size):
    if os.path.exists(os.path.join(os.path.dirname(__file__), "data.npy")):
        ...
        print("count ", count[1:10])
        print("data ", data[1:10])
        print("idx2word ", reverse_dictionary[1])
        print("word2idx ", dictionary['film'])
